...
function AssignmentRecordingSession() {
  ...
  const handleStop = async () => {
    ...
    const analysis = analyzeAudioSignal(samples, elapsed, a.difficulty, transcript);
  ...
  // If student already submitted this homework and is not actively retaking, show submitted summary
  if (existingAttempt && !isRetaking) {
    ...
    return (
      <div className="min-h-screen bg-ink-950 text-primary-warm">
        <div className="mx-auto flex min-h-screen w-full max-w-[500px] flex-col border-x border-hairline px-5 py-6">
          {/* Top Bar */}
          <div className="flex items-center justify-between">
            ...
            <span className="flex items-center gap-1.5 rounded-full border border-[#3FB8AF]/30 bg-[#3FB8AF]/10 px-2.5 py-1 text-[11px] font-medium text-[#3FB8AF]">
          ...
          {/* Assignment Header */}
          <div className="mt-6">
            <div className="flex items-center gap-1.5 text-[11px] font-semibold uppercase tracking-wider text-secondary-warm">
              <BookOpen size={13} className="text-[#3FB8AF]" />
              Homework Assignment · {a.difficulty}
            </div>
            <h1 className="mt-1 text-[22px] font-bold tracking-tight text-primary-warm">
              {a.title}
            </h1>
            <p className="mt-2 text-[14px] leading-relaxed text-secondary-warm">{a.prompt}</p>
          </div>
          ...
          <div className="mt-6 rounded-[12px] border border-hairline bg-ink-900 p-4 shadow-sm">
            ...
            <div className="flex items-center justify-between text-[12px] text-secondary-warm">
              ...
              <span className="font-mono text-[11px] text-tertiary-warm">
                {existingAttempt.createdAt
                  ? new Date(existingAttempt.createdAt).toLocaleDateString("en-US", {
                      month: "short",
                      day: "numeric",
                      hour: "numeric",
                      minute: "2-digit",
            ...
            <div className="mt-3 flex items-center gap-3">
              ...
              <div className="flex-1 flex flex-col gap-1">
                <div className="flex justify-between text-[10px] num text-tertiary-warm">
          ...
          <div className="mt-4 rounded-[8px] border border-hairline bg-ink-900 p-3.5 text-[12px] text-secondary-warm">
            ...
            {existingAttempt.teacherFeedback ? (
              ...
              <p className="text-tertiary-warm italic">
                Teacher will review your recording and provide feedback on this assignment soon.
              </p>
            )}
          </div>
          ...
          <div className="mt-8 flex flex-col gap-3 pb-8">
            ...
            >
              <RotateCcw size={16} />
              Retake Homework (Record New Attempt)
            </button>
            <Link
              to="/practice"
